        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 flex flex-col gap-6">
            <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-6 flex flex-col items-center text-center relative overflow-hidden backdrop-blur-md">
              <div className="absolute top-0 left-0 w-full h-20 bg-linear-to-r from-blue-600/20 to-purple-600/20 -z-10" />
            ...
            <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-6 backdrop-blur-md">
              ...
              <div className="mb-6 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                <p className="text-xs text-blue-400 flex items-center gap-2 font-medium">
                  ...
                  Demo Mode: Email and phone verifications are automatically set
                  to verified for demonstration purposes to avoid unnecessary
                  API calls.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <span className="inline-flex items-center gap-1 text-xs font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 rounded-xl self-start sm:self-auto cursor-default">
